    ...
    <Container>
      <div className="grid gap-10 lg:grid-cols-2 xl:grid-cols-3 text-[#414141]">
        <div className="lg:col-span-2 xl:col-auto ">
          <div className="flex flex-col justify-between w-full h-full bg-gray-100 px-4 py-4 sm:px-10 sm:py-6 rounded-2xl dark:bg-trueGray-800">
            <ProductCard
              image={productOneImg}
              name="Nasi Jinggo"
              price="Rp.5,000"
...
function ProductCard(props) {
  return (
    <div className="flex flex-col sm:flex-row items-center mt-8 space-y-4 sm:space-y-0 sm:space-x-3">
